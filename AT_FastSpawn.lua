...
function imgui.OnDrawFrame()
    ...
    if main_window_state.v then 
        ...
        if imgui.Checkbox(u8'����Spawn', checked_test3) then
	...
	if secondary_window_state.v then
		imgui.SetNextWindowPos(imgui.ImVec2((sw / 2), sh / 2), imgui.Cond.FirstUseEver, imgui.ImVec2(0.5, 0.5))
		imgui.Begin(u8'�������� �������', secondary_window_state, imgui.WindowFlags.AlwaysAutoResize + imgui.WindowFlags.NoResize + imgui.WindowFlags.NoCollapse + imgui.WindowFlags.ShowBorders)
		imgui.GetStyle().WindowTitleAlign = imgui.ImVec2(0.5, 0.5)
		imgui.PushFont(fontsize)
		imgui.Text(u8'      �������')
		imgui.SameLine()
		...
		for i = 0, #inputCommand do
			if inputCommand[i] then
				...
				if imgui.Combo("##selected" .. tostring(i), inputWait[i], {u8'0.5 ���', u8'1 ���', u8'1.5 ���', u8'2 ���', u8'3 ���'}, 5) then
		...
		if imgui.Button(u8'��������', imgui.ImVec2(210,24)) then
			...
			else sampAddChatMessage(tag .. '�� �������� ��������� - 10 ������.', -1) end
		end
		imgui.PopFont()
		imgui.End()
	end
