...
local version = 5.7 			 							-- Версия скрипта
...
function binder_key()
	while true do
		...
		wait(30)
		if isGamePaused() then AFK = true --запихнул в этот цикл поскольку здесь задержка больше и фпс будет больше
